...
import { Category, Subcategory, PartItem } from "./types";

export type { Category, Subcategory, PartItem };

export const categories: Category[] = [
    { id: "body-exterior", name: "Karosszéria elem (lemez)", slug: "karosszeria-elem", icon: IconCarDoor, keywords: ["karosszéria", "lemez", "külső", "bódé", "kombi", "sedan", "limuzin", "variant", "break", "avant", "touring", "sw", "kupé", "hatchback"] },
    { id: "lights", name: "Lámpa, index, világítás", slug: "lampa-vilagitas", icon: IconHeadlight, keywords: ["világítás", "lámpa", "fény", "optika"] },
    { id: "glass", name: "Üveg/ablak/tükör", slug: "uveg-ablak-tukor", icon: IconWindshield, keywords: ["szélvédő", "ablak", "tükör", "üveg"] },
    { id: "body-other", name: "Karosszéria egyéb", slug: "karosszeria-egyeb", icon: IconSideMirror, keywords: ["műanyag", "díszléc", "kiegészítő"] },
    { id: "interior", name: "Utastér", slug: "utaster", icon: IconCarSeat, keywords: ["beltér", "kárpit", "ülés", "műszerfal"] },
    { id: "displays", name: "Kijelzők, Hifi, GPS, telefon", slug: "kijelzok-hifi", icon: IconDashboard, keywords: ["navigáció", "rádió", "monitor", "hifi", "zene"] },
    { id: "cooling", name: "Hűtés-Fűtés, Levegő-Víz", slug: "hutes-futes", icon: IconRadiator, keywords: ["hűtő", "klíma", "fűtés", "víz"] },
    { id: "engine", name: "Motor, motorikus alkatrész", slug: "motor", icon: IconEngine, keywords: ["blokk", "hengerfej", "turbó", "erőforrás"] },
    { id: "electric-motor", name: "Elektro-motor, pumpa, generátor", slug: "elektro-motor", icon: IconAlternator, keywords: ["önindító", "generátor", "szivattyú", "villanymotor"] },
    { id: "ignition", name: "Gyújtás, Izzítás", slug: "gyujtas-izzitas", icon: IconSparkPlug, keywords: ["trafó", "gyertya", "indítás"] },
    { id: "ecu", name: "Vezérlő modul, érzékelő, jeladó", slug: "vezerlo-modul", icon: IconECU, keywords: ["elektronika", "számítógép", "szenzor", "modul"] },
    { id: "wiring", name: "Kapcsoló, kábel", slug: "kapcsolo-kabel", icon: IconSwitch, keywords: ["vezeték", "köteg", "csatlakozó"] },
    { id: "safety", name: "Biztonsági berendezés", slug: "biztonsag", icon: IconAirbag, keywords: ["légzsák", "öv", "feszítő", "védelem"] },
    { id: "locks", name: "Mechanika/Zár/Szerkezet", slug: "mechanika-zar", icon: IconKey, keywords: ["kilincs", "zár", "kulcs", "szerkezet"] },
    { id: "transmission", name: "Erőátvitel, váltó, bowden", slug: "valto", icon: IconGearShifter, keywords: ["sebességváltó", "kuplung", "hajtás"] },
    { id: "brakes", name: "Fék, ABS/ASR/ESP", slug: "fekrendszer", icon: IconBrakeDisc, keywords: ["megállás", "tárcsa", "betét", "nyereg"] },
    { id: "steering", name: "Futómű, kormányzás, felni", slug: "kormanyzas", icon: IconSteeringWheel, keywords: ["felfüggesztés", "lengőkar", "felni", "kerék"] },
    { id: "fuel", name: "Üzemanyag, hybrid", slug: "uzemanyagrendszer", icon: IconFuel, keywords: ["tank", "benzin", "dízel", "injektor", "hibrid"] },
    { id: "exhaust", name: "Kipufogó rendszer", slug: "kipufogo", icon: IconExhaust, keywords: ["dob", "katalizátor", "füst", "cső"] },
    { id: "other", name: "Egyéb alkatrészek", slug: "egyeb", icon: PlusCircle, keywords: ["vegyes", "apró", "kiegészítő"] },
];

export const subcategories: Subcategory[] = [
    // 1. Karosszéria elem (lemez)
    { id: "subcat-body-exterior-1000", categoryId: "body-exterior", name: "AJTÓ", slug: "ajto", keywords: ["lemez", "nyílászáró"] },
    { id: "sc-body-2", categoryId: "body-exterior", name: "LÖKHÁRÍTÓ", slug: "lokharito", keywords: ["lökös", "bumper", "lokos"] },
    ...
    { id: "sc-lights-2", categoryId: "lights", name: "HÁTSÓ LÁMPA", slug: "hatso-lampa", keywords: ["hátsó lámpa", "stop lámpa"] },
    { id: "sc-lights-3", categoryId: "lights", name: "KÖDLÁMPA", slug: "kodlampa", keywords: ["köd", "ködfény"] },
    { id: "sc-lights-4", categoryId: "lights", name: "IRÁNYJELZŐ", slug: "iranyjelzo", keywords: ["index", "villogó"] },

    // 3. Üveg/ablak/tükör
    { id: "sc-glass-1", categoryId: "glass", name: "SZÉLVÉDŐ", slug: "szelvedo", keywords: ["szélvédő üveg", "parabriz"] },
    { id: "sc-glass-2", categoryId: "glass", name: "OLDALABLAK ÜVEG", slug: "oldalablak", keywords: ["ajtóüveg", "oldalüveg"] },
    { id: "sc-glass-3", categoryId: "glass", name: "VISSZAPILLANTÓ TÜKÖR", slug: "visszapillanto", keywords: ["tükör", "oldaltükör"] },

    // 5. Utastér
    { id: "sc-interior-1", categoryId: "interior", name: "ÜLÉS", slug: "ules", keywords: ["fotel", "pad", "ülés"] },
    { id: "sc-interior-3", categoryId: "interior", name: "ABLAKEMELŐ", slug: "ablakemelo", keywords: ["emelő", "szerkezet"] },
    { id: "sc-interior-4", categoryId: "interior", name: "KORMÁNYKERÉK", slug: "kormanykerek", keywords: ["volán", "kormány"] },
    { id: "sc-interior-5", categoryId: "interior", name: "KÁRPITOK ÉS MŰANYAGOK", slug: "karpitok-es-muanyagok", keywords: ["tetőkárpit", "oldalkárpit", "műanyag panel"] },

    // 8. Motor, motorikus alkatrész
    { id: "sc-engine-1", categoryId: "engine", name: "HENGERFEJ ÉS RÉSZEI", slug: "hengerfej", keywords: ["hfej", "motorfej", "szelepfedél"] },
    { id: "sc-engine-2", categoryId: "engine", name: "FŐTENGELY ÉS RÉSZEI", slug: "fotengely", keywords: ["hajtókar", "dugattyú", "lendkerék"] },
    { id: "sc-engine-3", categoryId: "engine", name: "ADAGOLÓ / NAGYNYOMÁSÚ PUMPA", slug: "adagolo", keywords: ["pumpa", "szivattyú", "cr pumpa"] },
    { id: "turbo", categoryId: "engine", name: "TURBÓFELTÖLTŐ", slug: "turbo", keywords: ["turbó", "feltöltő"] },
    { id: "sc-engine-5", categoryId: "engine", name: "MOTORBLOKK", slug: "motorblokk", keywords: ["blokk", "fűzött blokk"] },
    { id: "ekszij", categoryId: "engine", name: "ÉKSZÍJ ÉS TARTOZÉKOK", slug: "ekszij", keywords: ["szíj", "feszítő", "görgő"] },
    { id: "sc-engine-6", categoryId: "engine", name: "SZÍVÓSOR ÉS LEVEGŐELLÁTÁS", slug: "szivosor", keywords: ["szívócsonk", "levegő"] },
    { id: "sc-engine-7", categoryId: "engine", name: "MOTORRÖGZÍTÉS ÉS BURKOLATOK", slug: "motorrogzites", keywords: ["motortartó", "bak", "pajzs"] },

    // 11. Vezérlő modul, érzékelő, jeladó
    { id: "sc-ecu-1", categoryId: "ecu", name: "MOTORVEZÉRLŐ (ECU)", slug: "motorvezerlo", keywords: ["computer", "számítógép", "vezérlő"] },
    { id: "sc-ecu-2", categoryId: "ecu", name: "KOMFORT ELEKTRONIKA", slug: "komfort-elektronika", keywords: ["modul", "bsi", "uch", "sam"] },
    { id: "sc-ecu-3", categoryId: "ecu", name: "ÉRZÉKELŐ / SZENZOR", slug: "erzekelo", keywords: ["szenzor", "jeladó", "gomba"] },

    // 13. Biztonsági berendezés
    { id: "sc-safety-1", categoryId: "safety", name: "LÉGZSÁK", slug: "legzsak", keywords: ["airbag", "lufi"] },
    { id: "sc-safety-2", categoryId: "safety", name: "LÉGZSÁK INDÍTÓ / ELEKTRONIKA", slug: "legzsak-vezerlo", keywords: ["indító", "átvezető"] },
    { id: "sc-safety-3", categoryId: "safety", name: "BIZTONSÁGI ÖV", slug: "biztonsagi-ov", keywords: ["öv", "feszítő"] },

    // 15. Erőátvitel, váltó, bowden
    { id: "sc-trans-1", categoryId: "transmission", name: "VÁLTÓ (SEBESSÉGVÁLTÓ)", slug: "valto", keywords: ["sebességváltó", "automata váltó", "kézi váltó", "hajtómű"] },
    { id: "sc-trans-2", categoryId: "transmission", name: "FÉLTENGELY", slug: "feltengely", keywords: ["tengely", "csukló"] },
    { id: "sc-trans-3", categoryId: "transmission", name: "KUPLUNG ÉS RÉSZEI", slug: "kuplung", keywords: ["tárcsa", "szerkezet", "kinyomó"] },
    { id: "sc-trans-4", categoryId: "transmission", name: "HAJTÁSLÁNC ÉS DIFFERENCIÁLMŰ", slug: "hajtaslanc-difi", keywords: ["difi", "osztómű", "kardán"] },

    // 16. Fék, ABS
    { id: "sc-brakes-1", categoryId: "brakes", name: "ABS EGYSÉG", slug: "abs", keywords: ["abs kocka", "tömb", "modul"] },
    { id: "sc-brakes-2", categoryId: "brakes", name: "FÉKNYEREG", slug: "feknyereg", keywords: ["nyereg", "fékmunkahenger"] },
    { id: "sc-brakes-3", categoryId: "brakes", name: "FÉKTÁRCSA ÉS FÉKBETÉT", slug: "fektarcsa-es-betet", keywords: ["tárcsa", "betét", "fék"] },
    { id: "sc-brakes-4", categoryId: "brakes", name: "FÉKRÁSEGÍTŐ / SZERVÓDOB", slug: "fekrasegito", keywords: ["dob", "szervódob"] },

    // 17. Futómű
    { id: "sc-steering-1", categoryId: "steering", name: "LENGŐKAR", slug: "lengokar", keywords: ["kar", "szilent", "gömbfej"] },
    { id: "sc-steering-2", categoryId: "steering", name: "KORMÁNYMŰ", slug: "kormanymu", keywords: ["kormánymű", "szervó"] },
    { id: "sc-steering-3", categoryId: "steering", name: "CSONKÁLLVÁNY / KERÉKAGY", slug: "csonkallvany", keywords: ["agy", "csapágy"] },
    { id: "sc-steering-4", categoryId: "steering", name: "LENGÉSCSILLAPÍTÓ ÉS RUGÓ", slug: "lengescsillapito", keywords: ["gátló", "teleszkóp", "rugó"] },
    { id: "sc-steering-5", categoryId: "steering", name: "FELNI / KERÉK / GUMI", slug: "felni-kerek", keywords: ["alufelni", "lemezfelni", "gumi", "kerék"] },

    // --- Newly added subcategories ---
    // 4. Karosszéria egyéb
    { id: "sc-body-other-1", categoryId: "body-other", name: "DÍSZLÉC", slug: "diszlec", keywords: ["embléma", "felirat", "szélesítés", "koptató"] },
    { id: "sc-body-other-2", categoryId: "body-other", name: "ABLAKTÖRLŐ MECHANIKA", slug: "ablaktorlo-mechanika", keywords: ["szerkezet", "mosó", "tartály", "kar"] },
    { id: "sc-body-other-3", categoryId: "body-other", name: "GÁZTELESZKÓP", slug: "gazteleszkop", keywords: ["teleszkóp", "gázstif", "teleszkop"] },

    // 6. Kijelzők, Hifi, GPS, telefon
    { id: "sc-displays-1", categoryId: "displays", name: "RÁDIÓ / FEJEGYSÉG", slug: "radio", keywords: ["hifi", "cd", "fejegység", "multimédia"] },
    { id: "sc-displays-2", categoryId: "displays", name: "NAVIGÁCIÓ (GPS)", slug: "navigacio", keywords: ["gps", "navigáció", "térkép"] },
    { id: "sc-displays-3", categoryId: "displays", name: "KIJELZŐ", slug: "kijelzo", keywords: ["monitor", "óra", "műszeregység", "virtual cockpit"] },

    // 7. Hűtés-Fűtés, Levegő-Víz
    { id: "sc-cooling-1", categoryId: "cooling", name: "VÍZRADIÁTOR", slug: "vizradiator", keywords: ["vízhűtő", "radiátor", "tartály", "ventilátor"] },
    { id: "sc-cooling-2", categoryId: "cooling", name: "KLÍMAHŰTŐ", slug: "klimahuto", keywords: ["klímakondenzátor", "szárító"] },
    { id: "sc-cooling-3", categoryId: "cooling", name: "FŰTŐMOTOR / VENTILÁTOR", slug: "futomotor", keywords: ["befúvó", "ellenállás", "sün"] },
    { id: "sc-cooling-4", categoryId: "cooling", name: "KLÍMA KOMPRESSZOR", slug: "klima-kompresszor", keywords: ["AC kompresszor", "klímapumpa"] },

    // 9. Elektro-motor, pumpa, generátor
    { id: "sc-electric-1", categoryId: "electric-motor", name: "GENERÁTOR", slug: "generator", keywords: ["töltés", "dinamó"] },
    { id: "sc-electric-2", categoryId: "electric-motor", name: "ÖNINDÍTÓ", slug: "onindito", keywords: ["indítómotor", "sztertér"] },
    { id: "sc-electric-3", categoryId: "electric-motor", name: "ABLAKTÖRLŐ MOTOR", slug: "ablaktorlo-motor", keywords: ["törlőmotor"] },

    // 10. Gyújtás, Izzítás
    { id: "sc-ignition-1", categoryId: "ignition", name: "GYÚJTÓTRAFÓ", slug: "gyujtotrafo", keywords: ["trafó", "sor"] },
    { id: "sc-ignition-2", categoryId: "ignition", name: "IZZÍTÓGYERTYA", slug: "izzitogyertya", keywords: ["gyertya", "relé"] },

    // 12. Kapcsoló, kábel
    { id: "sc-wiring-1", categoryId: "wiring", name: "KORMÁNYKAPCSOLÓ", slug: "kormanykapcsolo", keywords: ["bajuszkapcsoló", "tempomat"] },
    { id: "sc-wiring-2", categoryId: "wiring", name: "BELSŐ KAPCSOLÓK ÉS KEZELŐSZERVEK", slug: "belso-kapcsolok", keywords: ["ablakkapcsoló", "tükörkapcsoló"] },
    { id: "sc-wiring-3", categoryId: "wiring", name: "KÁBELKÖTEG", slug: "kabelkoteg", keywords: ["vezeték", "köteg", "csatlakozó"] },

    // 14. Mechanika/Zár/Szerkezet
    { id: "sc-locks-1", categoryId: "locks", name: "AJTÓZÁR", slug: "ajtozar", keywords: ["zár", "szerkezet", "kilincs"] },
    { id: "sc-locks-2", categoryId: "locks", name: "GYÚJTÁSKAPCSOLÓ", slug: "gyujtaskapcsolo", keywords: ["slusszkulcs", "kulcs", "zárhenger"] },

    // 18. Üzemanyag, hybrid
    { id: "sc-fuel-1", categoryId: "fuel", name: "ÜZEMANYAGSZIVATTYÚ (AC PUMPA)", slug: "uzemanyagszivattyu", keywords: ["ac pumpa", "benzinszivattyú", "gázolajpumpa"] },
    { id: "sc-fuel-2", categoryId: "fuel", name: "INJEKTOR", slug: "injektor", keywords: ["porlasztó", "befecskendező"] },

    // 19. Kipufogó rendszer
    { id: "sc-exhaust-1", categoryId: "exhaust", name: "KIPUFOGÓ DOB", slug: "kipufogo-dob", keywords: ["végdob", "leömlő"] },
    { id: "sc-exhaust-2", categoryId: "exhaust", name: "KATALIZÁTOR", slug: "katalizator", keywords: ["kat"] },
    { id: "sc-exhaust-3", categoryId: "exhaust", name: "RÉSZECSKESZŰRŐ (DPF)", slug: "reszecskeszuro", keywords: ["dpf", "fap"] },
