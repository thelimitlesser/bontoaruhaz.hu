    ...
    return (
        <>
            ...
            <ConfirmationModal 
                ...
                variant="warning"
                title="Fizetés kézi jóváhagyása"
                description="Biztosan megérkezett a pénz? Csak akkor hagyd jóvá manuálisan, ha a futár már elszámolt vele, vagy készpénzben átvetted!"
                confirmText="Fizetés Jóváhagyása"
            />
        </>
    );
}
